...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 12 15:01:45 2021

@author: kateyforsyth
"""

#Train Jarvis with combined data set
...
X_proj1= ["%s" % x for x in txt]

y_proj1 = ["%s" % y for y in action]
...
X_external = data_frame["TXT"]
    
y_external = data_frame["ACTION"]

#Cast Series to lists
X_external_list = X_external.tolist()
y_external_list = y_external.tolist()

X = X_proj1 + X_external_list

y = y_proj1 + y_external_list
...
text_clf = Pipeline([
    ...
    ('clf', svm.SVC(C = 1, kernel = "linear", gamma = 10)),
     ])
...
file = "jarvis_MOUNTAINTIGER_combined_data.pkl"
